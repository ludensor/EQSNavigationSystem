...
#include "EQSNavEnvQueryGenerator_TriangleTessellation.generated.h"
...
public:
	UEQSNavEnvQueryGenerator_TriangleTessellation(const FObjectInitializer& ObjectInitializer);
